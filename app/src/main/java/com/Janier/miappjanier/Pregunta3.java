...
public class Pregunta3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        au_correcto = MediaPlayer.create(Pregunta3.this,R.raw.buttonsounds);
        au_incorrecto = MediaPlayer.create(Pregunta3.this,R.raw.buttonsounds);
        au_text = MediaPlayer.create(Pregunta3.this,R.raw.buttonsounds);
    }
